...
class NimWSSServer:
    ...
    NIM_SKILLS = [
        ...
        {"id": "nim_patch_file", "name": "Parche de Código", "status": "Activa",
         "description": "Edita líneas específicas de archivos en la PC (find-and-replace quirúrgico)",
         "environment": "PC"},
        {"id": "nim_grep_search", "name": "Búsqueda en Código", "status": "Activa",
         "description": "Busca texto, regex, funciones o variables en archivos de la PC",
         "environment": "PC"},
        {"id": "nim_list_dir", "name": "Explorador de Proyecto", "status": "Activa",
         "description": "Escanea la estructura de carpetas de un proyecto en la PC",
         "environment": "PC"},
