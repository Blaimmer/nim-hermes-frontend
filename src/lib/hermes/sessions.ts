...
// ── Adaptación NIM PC: el cache de cola de transcripción es específico del
// store de Electron Desktop; aquí es un no-op para mantener la firma. ─────
type TranscriptTailRecord = { session_id: string; page: number; profile?: string }
export function recordTranscriptTail(_id: string, _page: unknown, _profile?: string): void {}
import type {
  PaginatedSessions,
  SessionInfo,
  SessionMessage,
